...
pub mod kv_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn get(
            ...
            req.extensions_mut().insert(GrpcMethod::new("proto.KV", "Get"));
        ...
        pub async fn put(
            ...
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("proto.KV", "Put"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod kv_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/proto.KV/Get" => {
                    ...
                    impl<T: Kv> tonic::server::UnaryService<super::GetRequest>
                    for GetSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as Kv>::get(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "proto.KV";
